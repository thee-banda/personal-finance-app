...
function Navbar() {
  ...
  return (
    <nav className="bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-100 px-3 sm:px-4 lg:px-6 py-2 sm:py-3 shadow-md transition">
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-2 sm:gap-4">
        <h1 className="font-bold text-base sm:text-lg lg:text-xl text-blue-600 dark:text-blue-400">{t.appName}</h1>
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <button
            ...
            className="bg-blue-600 hover:bg-blue-700 text-white px-2 sm:px-3 lg:px-4 py-1.5 sm:py-2 rounded-lg transition text-sm sm:text-base"
          >
            {lang}
          </button>
